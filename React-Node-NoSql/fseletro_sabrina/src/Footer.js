            ...
            <div className="collapse navbar-collapse justify-content-center" id="collapseNavbar">
                <ul className="nav">
                    <li className="nav-item">
                        <a className="nav-link active text-white" href="Produtos">Nossos produtos</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link active text-white" href="Lojas">Nossas lojas</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link active text-white" href="Fale_conosco">Fale conosco</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link active text-white" href="Pedidos">Faça seu pedido</a>
                    </li>
                </ul>
            </div>
        </nav>
