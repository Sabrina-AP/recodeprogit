            ...
            <form method='post' className="col-lg-8 mx-auto" onSubmit={envioMensagem}>
              <section className="container-fluid">
                  ...
                  <div className="form-group-sm">  
                    ...
                    <textarea className= "form-control"  name="mensagem"  value={mensagem} id="mensagem" value={mensagem}  onChange={event => setMensagem(event.target.value)} placeholder="Digite sua mensagem"></textarea>
