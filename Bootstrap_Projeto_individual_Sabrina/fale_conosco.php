            ...
            <form method="post">
                <section class="container-fluid">
                    <div class="form-group-sm">
                        ...
                        <input class= "form-control" type="text" name="nome" style="width: 500px" placeholder="Seu nome">
                        <label for="suamensagem">Mensagem:</label>
                        <textarea class= "form-control" name="mensagem" style="width: 500px" placeholder="Digite sua mensagem"></textarea>
                        <br>
